...
/*!!!!!!!!!!!DO NOT CHANGE END!!!!!!!!!!!*/
  ...
  selectedInstanceConfig: computed('instanceConfig', function() {
  ...
  instanceConfigChoices: computed('config.instanceType', 'config.zone', 'instanceTypeChoices', function() {
    ...
    const supportedFlavors = found.flavors.filter((f) => f.status === 'available' && f.cpuCount >= 4 && f.memoryCapacityInGB >= 8);
    if (instanceType === 9) {
